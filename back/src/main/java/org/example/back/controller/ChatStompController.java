...
public class ChatStompController {
    ...
    public void handleChatMessage(
            @Parameter(description = "채팅 메시지 요청 DTO") @Valid @Payload ChatMessageRequest request,
    ...
    public StompErrorResponse handleValidationException(MethodArgumentNotValidException ex) {
        String message = ex.getBindingResult().getAllErrors().get(0).getDefaultMessage();
        log.warn("[STOMP][VALIDATION] {}", message);
        return StompErrorResponse.of("VALIDATION_ERROR", message);
    }
